...
import {setPage, setTotalCollectionAmount} from "@/store/legacy store/userSlice";
import _ from "lodash";
import {useGetUserCollectionsQuery} from "@/store/graphql/COLLECTION.modify";
import {AUTH_SIGN_IN} from "@/store/legacy store/route.slice";
            ...
            <div className=" lg:w-[1200px] w-full">
                ...
                <div className="lg:max-w-[1200px] flex flex-col gap-6">
                    ...
                    >
                        ...
                        <CardFooter
                            className="h-1 m-0 p-0 bg-[hsl(var(--primary))] group-hover/collectionCard:visible invisible"></CardFooter>
                    </Card>
