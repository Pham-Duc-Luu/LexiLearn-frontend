"use client";
import {Avatar, AvatarProps, Button, Card, CardBody, CardHeader, CardProps, Divider, Spinner,} from "@heroui/react";
import {useEffect, useState} from "react";
import {XMLBuilder} from "fast-xml-parser";
import {useAppDispatch, useAppSelector} from "@/store/legacy store/hooks";
import {useTranslations} from "next-intl";
import {IoMdAdd} from "react-icons/io";
import {setAvatarByChooseIcon} from "@/store/legacy store/userSlice";
import {Avatar as ShadcnAvatar, AvatarFallback,} from "@/components/ui/avatar";
import DevelopmentProccessAlert from "@/components/DevelopmentProccessAlert";
import {useDispatch} from "react-redux";
import {handleOpen} from "@/store/legacy store/modalSlice";
