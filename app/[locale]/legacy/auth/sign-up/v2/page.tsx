...
import {Button, Card, CircularProgress, Input, Link,} from "@heroui/react";
import {useTranslations} from "next-intl";
import {FaFacebook, FaGoogle} from "react-icons/fa";
import {useGoogleOAuth2Mutation, useSignUpMutation,} from "@/store/RTK-query/authApi";
...
import {setAccessToken, setRefreshToken} from "@/store/legacy store/authSilce";
import {useAppDispatch} from "@/store/legacy store/hooks";
import {useRouter} from "@/i18n/routing";
import {AUTH_SIGN_IN, DASHBOARD_ROUTE,} from "@/store/legacy store/route.slice";
