...
export type GetFLashCardsInCollectionQuery = {
  __typename?: "Query";
...
export type GetNeedToReviewFlashCardsQuery = {
  __typename?: "Query";
  getNeedToReviewFlashCards: {
...
const injectedRtkApi = graphqlApi.injectEndpoints({
  endpoints: (build) => ({
    GetUserCollections: build.query<
      ...
      GetUserCollectionsQueryVariables | void
    >({
      query: (variables) => ({
        document: GetUserCollectionsDocument,
        variables,
      }),
    }),
    GetFLashCardsInCollection: build.query<
      GetFLashCardsInCollectionQuery,
      GetFLashCardsInCollectionQueryVariables
    >({
      query: (variables) => ({
        document: GetFLashCardsInCollectionDocument,
        variables,
      }),
    }),
    GetCollectionDetail: build.query<
      GetCollectionDetailQuery,
      GetCollectionDetailQueryVariables
    >({
      query: (variables) => ({
        document: GetCollectionDetailDocument,
        variables,
      }),
    }),
    GetNeedToReviewFlashCards: build.query<
      GetNeedToReviewFlashCardsQuery,
      GetNeedToReviewFlashCardsQueryVariables
    >({
      query: (variables) => ({
        document: GetNeedToReviewFlashCardsDocument,
        variables,
      }),
    }),
  }),
...
export const {
  ...
  useLazyGetNeedToReviewFlashCardsQuery,
} = injectedRtkApi;
