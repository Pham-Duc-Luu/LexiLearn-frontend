  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-neutral-700 dark:text-neutral-200 text-medium group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {button.label}
      </motion.span>
    </Button>
