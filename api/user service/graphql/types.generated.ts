...
export type QueryGetUserDeskArgs = {
  id: Scalars['ID']['input'];
};
...
export const { useGetUserDesksQuery, useLazyGetUserDesksQuery, useGetDesksQuery, useLazyGetDesksQuery } = injectedRtkApi;
